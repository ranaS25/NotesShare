...
const Sidebar = () => {
  ...
  return (
    <div
      className="w-max z-20 bg-slate-50 dark:bg-slate-800 border-r-[1px] dark:border-slate-600 flex flex-col p-4 justify-start gap-5 flex-wrap dark:text-slate-50 hover:drop-shadow-lg"
      onMouseOver={() => {
        setExpanded(true);
      }}
      onMouseOut={() => {
